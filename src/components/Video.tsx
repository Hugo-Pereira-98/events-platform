				...
				<div className="flex items-start gap-16">
					<div className="flex-1">
						...
						<div className="flex items-center gap-4 mt-6">
							<img
								src="https://github.com/hugo-pereira-98.png"
								className="h-16 rounded-full border2 border-blue-500"
								alt="Hugo Picture"
							/>
							<div className="leading-relaxed">
								<strong className="font-bold text-2xl block">Hugo Pereira</strong>
								<span className="text-gray-200 text-sm block">Dev at Reshift</span>
							</div>
						</div>
					</div>
					...
					>
						...
						<div className="py-6 leading-relaxed">
							<strong className="text-2xl">
								Catálogo
								<p className="text-sm text-gray-200 mt-2">
									Descubra todo o catálogo de cursos hoje disponíveis na plataforma.
								</p>
							</strong>
						</div>
						<div className="h-full p-6 flex items-center">
